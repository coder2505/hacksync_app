...
class _ReportAComplaintState extends State<ReportAComplaint> {
  ...
  Future<void> _updateLocation(LatLng position) async {
    ...
    // FIX: Check if the map is ready before calling move()
    // to avoid "You need to have the FlutterMap widget rendered at least once" error.
    ...
    try {
      ...
      setState(() => _currentAddress = "Address location found at ${position.latitude.toStringAsFixed(4)}, ${position.longitude.toStringAsFixed(4)}");
    }
  }
  ...
  Future<void> _pickImages() async {
    ...
    if (selectedImages.isNotEmpty) {
      setState(() => _imageFiles.addAll(selectedImages));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("New Complaint", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        backgroundColor: Colors.white,
        elevation: 0,
          ...
          children: [
            ...
            _buildRow(
              ...
              child: DropdownButtonFormField<String>(
                ...
                items: _incidentTypes.map((t) => DropdownMenuItem(value: t, child: Text(t, style: const TextStyle(fontSize: 14)))).toList(),
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == _imageFiles.length) return _buildAddButton();
                  ...
                  const Padding(
                    ...
                    child: Text("Upload up to 5 clear photos", style: TextStyle(fontSize: 11, color: Colors.grey)),
                  ),
                ],
              ),
            ),

            // Location with flutter_map
            _buildRow(
              label: "Location",
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(_currentAddress, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.blueGrey)),
                  ),
                ],
              ),
            ),
            ...
            _buildRow(
              ...
              child: TextFormField(
                ...
                readOnly: true,
                decoration: _fieldDecoration(null).copyWith(fillColor: Colors.grey.shade50, filled: true),
            ...
            CheckboxListTile(
              ...
              title: const Text("Submit as anonymous report", style: TextStyle(fontSize: 14)),
              value: _isAnonymous,
